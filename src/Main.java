...
public class Main {
    public static void main(String[] args) {
        ...
        Category eleCategory = new Category(product1, product2, product3, product4, "Electros");
        products.add(product5);
        products.add(product6);
        products.add(product7);
        products.add(product8);
        Category clothCategory = new Category(product5, product6, product7, product8, "Clothes");
        products.add(product9);
        products.add(product10);
        products.add(product11);
        products.add(product12);
        Category foodCategory = new Category(product9, product10, product11, product12, "food");
